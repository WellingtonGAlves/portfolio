...
export const translations = {
  en: {
    ...
    hero: {
      ...
      footer: (
        <>
          💬 I'll review your project and share my opinion{" "}
          <span className="text-primary">with no commitment</span>. Let's talk!
        </>
      ),
    ...
    timeline: {
      ...
      items: [
        ...
        },
        {
          ...
          description: "Deep dive into Angular with SPA and advanced development courses.",
          icon: "education" as const,
        },
        {
          year: "2022-2024",
  ...
  pt: {
    ...
    hero: {
      ...
      footer: (
        <>
          💬 Analiso seu projeto e dou minha opinião{" "}
          <span className="text-primary">sem compromisso</span>. Vamos conversar!
        </>
      ),
      whatsapp: "(41) 9 9582-9776",
    },
